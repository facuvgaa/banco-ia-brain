...
public class ClaimController {
    ...
    @DeleteMapping("/profile-investor/{customerId}")
    @Transactional
    public ResponseEntity<Void> deleteProfileInvestor(@PathVariable String customerId) {
        log.info("Borrando perfil inversor: {}", customerId);
        profileInvestorService.deleteByCustomerId(customerId);
