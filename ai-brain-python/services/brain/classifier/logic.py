from classifier.prompt import PROMPT_BRAIN_CLS
...
VALID_WORKFLOWS = ["workflow_prestamos", "workflow_tarjetas", "workflow_cuentas"]
...
def get_brain_classification(message_content):
    ...
    try:
        ...
        return intent if intent in VALID_WORKFLOWS else "workflow_prestamos"

    except Exception as e:
        logger.error(f"Error en la clasificacion brain: {e}")
        return "workflow_prestamos"
