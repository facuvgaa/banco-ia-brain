...
class TriageResult(BaseModel):
    desicion: Literal["RESOLVE", "ESCALATED"] = Field(description="RESOLVE si es una duda general. ESCALATE si el cliente habla de una transacción, saldo o problema técnico específico."
    )
